...
void ofApp::setupDeferred(){
    ...
    pl2.add(pl2_pos.set("Position", ofVec3f(0,0,0), ofVec3f(-1000), ofVec3f(1000)));
    pl2.add(pl2_diff.set("Diffuse Color", ofFloatColor(0.8,0.9,1.,1.)));
    pl2.add(pl2_spe.set("Specular Color", ofFloatColor(1.)));
    ...
    shadow.add(sha_amb.set("Ambient", 0.2, 0.0, 1.0));
    shadow.add(sha_dif.set("Diffuse", 0.2, 0.3, 1.0));
...
void ofApp::updateDeferredParam(){
    ...
    shadowLightPass->setPosition(-1000, 2000.0, 0);
    shadowLightPass->lookAt(ofVec3f(0.0));
